...
from . import info  # @UnresolvedImport
...
setup(
    ...
    author_email=('woodchips at rochester.rr.com, ' +
                  'Per.Andreas.Brodtkorb at gmail.com'),
    description=('Solves automatic numerical differentiation problems ' +
